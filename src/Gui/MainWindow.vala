...
namespace SpriteHut.Gui
{
    public class MainWindow : Gtk.ApplicationWindow {
        ...
        public MainWindow (Gtk.Application app, Document? doc)
        {
...
//        paint tools
        ...
        public void on_document_add(SimpleAction action, Variant? parameter) {
            ...
            if (document.active_element is Layer) {
//            add a sibling Layer at the same level
                var layer = new Layer(document.width, document.height, document.mode);
                document.add_sibling(layer, document.active_element_iter);
            }
            else if (document.active_element is SpriteHut.Data.Frame) {
//            add a sibling Layer at the same level
                var frame = new SpriteHut.Data.Frame();
                var frame_iter = document.add_sibling(frame, document.active_element_iter);
//                then some children
                var layer = new Layer(document.width, document.height, document.mode);
                document.add(layer, frame_iter);
            }
            else if (document.active_element is Animation) {
            ...
            else if (document.active_element is Sprite) {
