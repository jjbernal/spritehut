...
public class TestFreeImageImage : Object {
    public static void test_get_pixel_color_indexed () {
        ...
        uint8[] pixel_array = new uint8[4] {0, 1,
                                              2, 3};
        Image image = new FreeImageImage.from_pixel_data(2, 2, 8, pixel_array);
        image.palette = new Palette();
//        image.palette.color_list.add(Gdk.RGBA());
...
//        stdout.printf("red.red %f\n", red.red);
    ...
    public static void test_get_pixel_color_bgra () {
        // a dummy 2x2 32-bit BGRA image consisting formed by a red, green, blue and white pixel
        uint8[] pixel_array = new uint8[16] {0, 0, 255, 255,
         0, 255, 0, 255,
         255, 0, 0, 255,
         255, 255, 255, 255};
        Image image = new FreeImageImage.from_pixel_data(2, 2, 32, pixel_array);
        image.palette = new Palette();
...
//        stdout.printf("red.red %f\n", red.red);
    ...
    public static void test_to_rgba () {
        Image image = new FreeImageImage(16, 16, Image.Mode.INDEXED);
        Image rgba_copy = image.to_rgba();
        assert (rgba_copy.mode == Image.Mode.RGBA);
    }
